...
class Product(Base):
    ...
    category: Mapped[str | None] = mapped_column(String(80), nullable=True)
    catalog_market: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    ...
    image_verification_status: Mapped[str] = mapped_column(String(48), default="unavailable")
